...
h=new elDialogForm(g);h.append([this.rte.i18n("Youtube URL"),this.youtube_url],null,true);h.append([this.rte.i18n("Width"),a("<span />").append(this.youtube_w).append(" px")],null,true);h.append([this.rte.i18n("Height"),a("<span />").append(this.youtube_h).append(" px")],null,true);h.open();this.rte.ui.update(true)};this.update=function(){this.domElem.removeClass("disabled active")};this.set=function(o,g,p){var q=(o.match(/youtu\.be\/(\w+)/)||o.match(/youtube.com\/watch\?(?:[^&]+&)*v=(\w+)/)||[])[1];
if(q){var k='<iframe width="'+g+'" height="'+p+'" src="http://www.youtube.com/embed/'+q+'?wmode=transparent" frameborder="0" allowfullscreen="true"> </iframe>';var r="youtube-"+Math.random().toString().substring(2);this.rte.filter.scripts[r]=k;var j='<img id="'+r+'" src="'+this.rte.filter.url+'pixel.gif" class="elrte-protected elrte-iframe" style="width:'+g+"; height:"+p+'">';this.rte.history.add();this.rte.selection.insertHtml(j)}}}})(jQuery);elRTE.prototype.options.buttons.youtube="Insert Youtube video";