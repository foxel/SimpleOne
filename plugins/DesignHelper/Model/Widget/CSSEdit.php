...
/**
 */
class DesignHelper_Model_Widget_CSSEdit extends SOne_Model_Widget
{
    /**
    ...
    {
        if (!$env->user->adminLevel) {
            return null;
        }

        $node = new FVISNode('SONE_DESIGNHELPER_WIDGET_CSSEDIT', 0, $env->getVIS());
