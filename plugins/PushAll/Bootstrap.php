...
/**
 * Class PushAll_Bootstrap
 */
class PushAll_Bootstrap implements SOne_Interface_PluginBootstrap
{
    /** @var PushAll_Plugin */
    ...
    {
        self::$_pluginInstance = new PushAll_Plugin($app, $config);
        $app->getEnv()->getVIS()->addAutoLoadDir(realpath(dirname(__FILE__)).'/styles/simple');
        SOne_Model_Widget::addNamespace('PushAll_Model_Widget');
    }
